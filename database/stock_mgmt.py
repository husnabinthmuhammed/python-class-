...
def create_database():
    mydb = mysql.connector.connect(host="localhost", user="root", passwd="Husna@12 ",
                                   database=" stock ")
...
def update_product():
    mydb = mysql.connector.connect(host="localhost", user="root", passwd="Husna@12", database="stock ")
    mycursor = mydb.cursor()
